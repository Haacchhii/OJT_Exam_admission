  ...
  return (
    <div className="gk-card p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <Input label="Last School Attended" value={form.prevSchool} onChange={set('prevSchool')} required placeholder="Name of previous school" />
        <div className="md:col-span-2">
          <TextArea label="School Address" value={form.schoolAddress} onChange={set('schoolAddress')} required placeholder="Street, Barangay, Municipality, Province" rows={2} />
        </div>
        <div>
        ...
        <Input label="Learner Reference Number (LRN)" value={form.lrn} onChange={(e: ChangeEvent<HTMLInputElement>) => { const v = e.target.value.replace(/\D/g, ''); setForm(f => ({ ...f, lrn: v })); }} required placeholder="12-digit LRN" maxLength={12} />
        ...
        <Input label="School Year" value={form.schoolYear} onChange={set('schoolYear')} required placeholder="e.g. 2026-2027" />
