...
import { getExams, getExamSchedules, getMyRegistrations, registerForExam, getExamForStudent, startExam as apiStartExam, getAvailableSchedules } from '../../api/exams';
import { getMyResult, submitExamAnswers } from '../../api/results';
...
import type { Exam, ExamSchedule, ExamRegistration, ExamResult, ExamQuestion, QuestionChoice, User } from '../../types';
...
function ScheduleView({ myReg, myResult, onLobby, onRefresh, user }: ScheduleViewProps) {
...
/* ===== Scheduled View (extracted to avoid hooks-after-early-return) ===== */
...
function LiveExam({ exam, registration }: LiveExamProps) {
