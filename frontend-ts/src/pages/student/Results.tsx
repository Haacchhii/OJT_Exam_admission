    ...
    <div>
      ...
      <div className={`rounded-xl border-2 p-6 mb-6 ${isPendingEssayReview ? 'bg-gold-50 border-gold-200' : passed ? 'bg-forest-50 border-forest-200' : 'bg-red-50 border-red-200'}`}>
        ...
        <div className="mt-4 rounded-lg border border-forest-200 bg-white px-4 py-3 text-sm">
          ...
          <p className="text-gray-600 mb-2">Your entrance exam is complete. You can now submit your admission application or monitor it from the dashboard.</p>
          ...
          <div className="space-y-4">
            {exam.questions.map((q, i) => {
              if (q.questionType === 'mc' || q.questionType === 'true_false') {
                ...
                const essay = essayAnswers.find((a: EssayAnswer) => a.questionId === q.id);
                return (
