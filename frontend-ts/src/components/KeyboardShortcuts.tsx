...
export function KeyboardShortcutsProvider({ children, navigate, role }: Props) {
  const [helpOpen, setHelpOpen] = useState(false);
  const perms: string[] = ROLE_PERMISSIONS[role] || (role === 'applicant' ? ['admissions', 'exams', 'results'] : []);
