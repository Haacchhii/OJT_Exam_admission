...
export function sendTemporaryPasswordEmail({ to, firstName, tempPassword }) {
  return sendEmail({
    to,
    subject: `Your Temporary Password — ${SCHOOL_NAME}`,
    html: wrap(`
      <h2 class="title">Your Account Is Ready 🔐</h2>
      <p class="subtitle">A temporary password has been generated for your account.</p>
      <p>Hi ${firstName}, your account has been created at <b>${SCHOOL_NAME}</b>. Use the temporary password below to sign in for the first time:</p>
      <div class="highlight-box info">
        <strong>Temporary Password</strong>
        <span style="display:block;font-size:20px;letter-spacing:1px;font-weight:700;color:#1a3a2a;margin-top:4px;word-break:break-word;">${tempPassword}</span>
      </div>
      <div class="highlight-box warning">
        <strong>Security Notice</strong>
        <span>Please sign in and change this password immediately after your first login. This temporary password was generated by the system and sent only to this email address.</span>
      </div>
      <a class="btn" href="${appUrl}/#/login">Sign In</a>
      <p style="font-size:13px;color:#6b7280;">If you did not expect this account, please contact the registrar's office right away.</p>
    `),
  });
}
