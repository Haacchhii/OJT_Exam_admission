...
import { trackApplication } from '../../api/admissions.js';
...
function AdmissionResult({ data, trackingId }) {
  return (
    <div className="gk-card p-6">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {ADMISSION_PROGRESS_STEPS.map((step, i) => {
          const statusOrder = { 'Submitted': 0, 'Under Screening': 1, 'Under Evaluation': 2, 'Accepted': 3, 'Rejected': -1 };
...
function ExamResult({ data, trackingId }) {
